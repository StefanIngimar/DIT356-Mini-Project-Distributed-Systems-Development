 ...
 * 
 * The Booking Service is running as replicas, and have unique IDs as hostnames by default.
 * Appending this unique ID to 'booking-service-<ID>' to identify the service instance in 
 * Seq logging service. 
 */
...
const logger = winston.createLogger({
    ...
    defaultMeta: { service: `booking-service-${hostname}` },  
    transports: [
